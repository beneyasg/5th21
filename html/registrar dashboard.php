...
<body>
    ...
    include("../phps/db_connection.php");
       $query1 = "SELECT * FROM `የባለይዞታው_መረ` WHERE `ጾታ`='ሴ'";
       $result1 = mysqli_query($conn, $query1);
       $num_female = mysqli_num_rows($result1);
       $query2 = "SELECT * FROM `የባለይዞታው_መረ` WHERE `ጾታ`='ወ'";
       $result2 = mysqli_query($conn, $query2);
       $num_male = mysqli_num_rows($result2);
       $query3 = "SELECT * FROM `የባለይዞታው_መረ` WHERE `ጾታ`='ወ' and `ጾታ`='ሴ'";
       $result3 = mysqli_query($conn, $query3);
       $num_male_and_female = mysqli_num_rows($result3);
    ?>
    <div class="side-menu">
        ...
        <ul>
            ...
            <li><a href="../html/calculate.html">&nbsp;<span>አስላና መዝግብ</span> </li>
            ...
            <div class="content-2">
                <div class="recent-payments">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>እማዎራ </td>
                            <td><?php echo $num_female;?></td>
                            <td>50000</td>
                        </tr>
                        <tr>
                            <td>አባዎራ </td>
                            <td><?php echo $num_male;?></td>              
                            <td>1000000</td>
                        </tr>
                        <tr>
                            <td> እማዎራና አባዎራ </td>
                            <td><?php echo $num_male_and_female;?></td>          
                            <td>1500000</td>
                        </tr>
                        <tr>
                            <td>የጋር መሬቶች </td>
